 ...
 */
    ...
    (() => {
                ...
                function initSpollerBody(spollersBlock, hideSpollerBody = true) {
                    ...
                    if (spollerTitles.length) {
                        ...
                        spollerTitles.forEach((spollerTitle => {
                            ...
                            } else spollerTitle.setAttribute("tabindex", "-1");
                        }));
                    }
                }
        ...
        function menuInit() {
            if (window.innerWidth < 991.98) if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".catalog-menu__button")) {
                    bodyLockToggle();
        ...
        function initSliders() {
            ...
            if (document.querySelector(".slider-main__slider")) new core(".slider-main__slider", {
                ...
                loop: true,
                navigation: {
                    nextEl: ".slider-main__slider .controls-arrows__arrow_prev",
                    prevEl: ".slider-main__slider .controls-arrows__arrow_next"
                },
                on: {}
            });
        ...
        window.onload = function() {
            ...
            function documentActions(e) {
                ...
                if (window.innerWidth > 991.98) {
                    if (targetElement.closest(".catalog-menu__button")) document.documentElement.classList.toggle("menu-open");
                    if (!targetElement.closest(".header-catalog__body") && document.documentElement.classList.contains(".menu-open")) document.documentElement.classList.remove("menu-open");
                }
            ...
            if (document.querySelector(".filter-catalog__title") && window.innerWidth < 992) document.querySelector(".filter-catalog__title").addEventListener("click", (e => {
